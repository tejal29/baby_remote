...
func (a *admissionHook) ValidatingResource() (plural schema.GroupVersionResource, singular string) {
	return schema.GroupVersionResource{
			Group:    "admission.babyremote.com",
			Version:  "v1beta1",
			Resource: "imageSecPolicy",
		},
		"imagesecuritypolicy"
}
...
func (a *admissionHook) Validate(admissionSpec *admissionv1beta1.AdmissionRequest) *admissionv1beta1.AdmissionResponse {
	...
	if (admissionSpec.Operation != (admissionv1beta1.Create, admissionv1beta1.Update) || len(admissionSpec.SubResource) != 0)
	{
		status.Allowed = true
		return status
	}
